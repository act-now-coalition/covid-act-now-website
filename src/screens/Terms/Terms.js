...
import { Wrapper, Content, StyledContactLink } from './Terms.style';
    ...
    <Wrapper>
      <Content>
        ...
        <Typography variant="body1" component="p">
          ...
          set out below are the legal terms that actually govern your use of our
          Website, and we encourage you to read them. In the event of any
          inconsistency between this quick summary and the full Terms of Use,
          the full Terms of Use will apply.
        </Typography>
        <Typography>
          <ul>
            <li>
              Our model is intended to help make fast decisions, not predict the
              future.
            </li>
            <li>
              Available data and information is changing daily (and hourly and
              by the minute). We’re doing our best to keep up with this, but the
              model may and likely will change given new data, a change in
            ...
            <li>
              ...
              purpose and not for any bad purposes.
            </li>
            <li>
              Feel free to use and share our model, data, and anything else for
              good purposes.
            </li>
          </ul>
        </Typography>
        ...
        <Typography variant="body1" component="p">
          ...
          CoVidActNow.org ("<b>Company</b>," "<b>we</b>," or "<b>us</b>"). The
          following terms and conditions, together with any documents they
          expressly incorporate by reference (collectively, "<b>Terms of Use</b>
          "), govern your access to and use of CoVidActNow.org, including any
          content, functionality and services offered on or through
          CoVidActNow.org (the "<b>Website</b>"), whether as a guest or a
          registered user.
        </Typography>
        <Typography variant="body1" component="p">
        ...
        <Typography variant="body1" component="p">
          You are responsible for ensuring that all persons who access the
        ...
        <Typography variant="body1" component="p">
          ...
          (including but not limited to all information, software, text, data,
          displays, images, video and audio, and the design, selection and
          arrangement thereof) (collectively, the “<b>Materials</b>”), are owned
          by the Company, its licensors or other providers of such material and
        ...
        <Typography variant="body1" component="p">
          ...
          you have made. Except as expressly provided herein, no right, title or
          interest in or to the Website or any Material or content on the
        ...
        <Typography variant="body1" component="p">
          ...
          accuracy, completeness or usefulness of this information. You
          acknowledge and agree that you are aware of: (1) the non-exhaustive
          list of known limitations of the model (available{' '}
          <a href="https://docs.google.com/document/d/1ETeXAfYOvArfLvlxExE0_xrO5M4ITC0_Am38CRusCko/preview#">
            here
          </a>
          , as updated and amended from time to time), and (2) that the model
          may and likely will change given new data, a change in modeling
          approach, or other reasons. Any reliance you place on such information
          ...
          you or any other visitor to the Website, or by anyone who may be
