...
export const LOCATION_SUMMARY_LEVELS: LevelInfoMap = {
  ...
  [Level.MEDIUM]: {
    ...
    detail: locationName =>
      `${locationName} is on track to achieve “herd immunity”. COVID is spreading in a slow and controlled fashion and ${locationName}’s COVID preparedness meets international standards.`,
  },
  [Level.MEDIUM_HIGH]: {
