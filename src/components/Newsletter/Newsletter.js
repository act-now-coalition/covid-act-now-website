  ...
  render() {
    ...
    return (
      <StyledNewsletter>
        ...
        <form ref={f => this.form = f} className="js-cm-form" id="subForm" method="post" data-id="2BE4EF332AA2E32596E38B640E905619AA6E1FB8D17A78ED48A8BBBF6B7BCEE2B5CA9AB5B4861F0A4E7AD231EC5D9077A3A8C1F7BFD94F2E4DA103E6791E7F2A">
          ...
          <input ref={i => this.emailInput = i} autoComplete="Email" aria-label="Email" placeholder="Enter your email address" className="js-cm-email-input qa-input-email" id="fieldEmail" maxLength="200" name="cm-wuyluk-wuyluk" required="" type="email" />
