...
import ChartCaseDensityFeedback from 'components/Charts/ChartCaseDensityFeedback';
      ...
      {!projection ? (
        ...
        <>
          <ChartContentWrapper>
            ...
            />
            <MainContentInner>
              <h1>Prevalence Feedback</h1>
              <p>
                solid line: prevalence by cases, dashed line: prevalence by
                deaths
              </p>
              <ChartCaseDensityFeedback
                series={[
