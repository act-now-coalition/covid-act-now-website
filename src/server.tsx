...
export const render = async (url: string) => {
  ...
  const stats = await getStatsFile();

  const extractor = new ChunkExtractor({
    ...stats,
    // webpack config from razzle sets the entrypoint to "client"
    entrypoints: ['client'],
  });
...
<head>
  ...
  ${staticData.scStyleTags}
  <!-- end injected styled-components styles -->
  <!-- loadable-components script tags -->
  ${staticData.scriptTags}
  <!-- end loadable-components script tags -->
  <!-- loadable-components link tags -->
  ${staticData.linkTags}
  <!-- end loadable-components link tags -->
</head>
