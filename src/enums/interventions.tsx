...
export const STATE_TO_CALCULATED_INTERVENTION_COLOR = CalculatedInterventionJSON as Record<
  string,
  string
>;
export const FIPS_CODE_TO_CALCULATED_INTERVENTION_COLOR = CalculatedCountyInterventionJSON as Record<
  string,
  string
>;

function stateInterventions(): Record<string, string> {
